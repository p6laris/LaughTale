...
public class ComponentsModel : PageModel
{
    ...
    {
        new("Component Suite", "/components"),
        new("Form Controls", "/components#sec-input-text"),
        new("Live Gallery")
    };
    ...
    public List<BreadcrumbItem> BreadcrumbBasic { get; set; } = new()
    {
        ...
        new("Electronics", "/components"),
        new("Laptops", "/components"),
        new("Dell")
    };
    ...
    public List<BreadcrumbItem> BreadcrumbRoute { get; set; } = new()
    {
        ...
        new("InputText", "/components"),
        new("Variants", "/components"),
        new("Filled", "/components"),
        new("Outlined")
    };
    ...
    {
        new("Products", "/components", Icon: "package"),
        new("Electronics", "/components", Icon: "zap"),
        new("Computers", "/components", Icon: "monitor"),
        new("Laptops", "/components", Badge: "Apple", BadgeSeverity: "primary"),
        new("Dell")
    };
    ...
    public List<MenuItem> TieredMenuRouterItems { get; set; } = new()
    {
        new(Label: "Router", Icon: "palette", Items: new()
        {
            ...
            new(Label: "UI Kit", Route: "/components")
        }),
