...
public static class LucideIcons
{
    private static readonly Dictionary<string, string> Icons = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["map-pin"] = @"<svg xmlns=""http://www.w3.org/2000/svg"" width=""{0}"" height=""{0}"" viewBox=""0 0 24 24"" fill=""none"" stroke=""currentColor"" stroke-width=""2"" stroke-linecap=""round"" stroke-linejoin=""round""><path d=""M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z""/><circle cx=""12"" cy=""10"" r=""3""/></svg>",
        ["globe"] = @"<svg xmlns=""http://www.w3.org/2000/svg"" width=""{0}"" height=""{0}"" viewBox=""0 0 24 24"" fill=""none"" stroke=""currentColor"" stroke-width=""2"" stroke-linecap=""round"" stroke-linejoin=""round""><circle cx=""12"" cy=""12"" r=""10""/><path d=""M12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 0-20""/><path d=""M2 12h20""/></svg>",
        ["dollar-sign"] = @"<svg xmlns=""http://www.w3.org/2000/svg"" width=""{0}"" height=""{0}"" viewBox=""0 0 24 24"" fill=""none"" stroke=""currentColor"" stroke-width=""2"" stroke-linecap=""round"" stroke-linejoin=""round""><line x1=""12"" x2=""12"" y1=""2"" y2=""22""/><path d=""M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6""/></svg>",
        ["star"] = @"<svg xmlns=""http://www.w3.org/2000/svg"" width=""{0}"" height=""{0}"" viewBox=""0 0 24 24"" fill=""none"" stroke=""currentColor"" stroke-width=""2"" stroke-linecap=""round"" stroke-linejoin=""round""><polygon points=""12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2""/></svg>",
        ["clock"] = @"<svg xmlns=""http://www.w3.org/2000/svg"" width=""{0}"" height=""{0}"" viewBox=""0 0 24 24"" fill=""none"" stroke=""currentColor"" stroke-width=""2"" stroke-linecap=""round"" stroke-linejoin=""round""><circle cx=""12"" cy=""12"" r=""10""/><polyline points=""12 6 12 12 16 14""/></svg>",
        ["phone"] = @"<svg xmlns=""http://www.w3.org/2000/svg"" width=""{0}"" height=""{0}"" viewBox=""0 0 24 24"" fill=""none"" stroke=""currentColor"" stroke-width=""2"" stroke-linecap=""round"" stroke-linejoin=""round""><path d=""M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z""/></svg>",
        ...
        ["plus"] = @"<svg xmlns=""http://www.w3.org/2000/svg"" width=""{0}"" height=""{0}"" viewBox=""0 0 24 24"" fill=""none"" stroke=""currentColor"" stroke-width=""2.5"" stroke-linecap=""round"" stroke-linejoin=""round""><path d=""M5 12h14""/><path d=""M12 5v14""/></svg>",
        ["minus"] = @"<svg xmlns=""http://www.w3.org/2000/svg"" width=""{0}"" height=""{0}"" viewBox=""0 0 24 24"" fill=""none"" stroke=""currentColor"" stroke-width=""2.5"" stroke-linecap=""round"" stroke-linejoin=""round""><path d=""M5 12h14""/></svg>"
    };
