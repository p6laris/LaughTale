...
Write-Host "🏴‍☠️ [SoftMax.LaughTale] Starting all services..." -ForegroundColor Cyan
...
Start-Process dotnet -ArgumentList "run --project SoftMax.LaughTale.Docs/SoftMax.LaughTale.Docs.csproj --urls http://localhost:5001" -WindowStyle Normal

# 3. Launch Showcase Portal on Port 5000
Write-Host "🏝️ Launching Enterprise Showcase on http://localhost:5000..." -ForegroundColor Green
Start-Process dotnet -ArgumentList "run --project SoftMax.LaughTale.Showcase/SoftMax.LaughTale.Showcase.csproj --urls http://localhost:5000" -WindowStyle Normal
