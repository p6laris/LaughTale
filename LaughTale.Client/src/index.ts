...
defineIsland('auto-complete', () => import('./components/autocomplete'));
defineIsland('color-picker', () => import('./components/color-picker'));
defineIsland('colorpicker', () => import('./components/color-picker'));
...
defineIsland('cascade-select', () => import('./components/cascadeselect'));
defineIsland('treeselect', () => import('./components/tree-select'));
...
defineIsland('floatlabel', () => import('./components/float-label'));
defineIsland('ifta-label', () => import('./components/ifta-label'));
defineIsland('iftalabel', () => import('./components/ifta-label'));
...
defineIsland('inputtext', () => import('./components/input-text'));
