...
namespace SoftMax.LaughTale.Generators;

/// <summary>
/// Roslyn Incremental Source Generator &amp; Diagnostic Analyzer for SoftMax.LaughTale.
...
public class IslandGenerator : IIncrementalGenerator
{
    ...
    private static readonly DiagnosticDescriptor InvalidIslandNameRule = new(
        ...
        category: "SoftMax.LaughTale.Naming",
    ...
    private static readonly DiagnosticDescriptor NonSerializableTypeRule = new(
        ...
        category: "SoftMax.LaughTale.Serialization",
    ...
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        ...
        context.RegisterSourceOutput(allIslands, static (spc, results) =>
        {
            ...
            spc.AddSource("SoftMax.LaughTale.TypeScriptManifest.g.cs", SourceText.From(GenerateManifestComment(tsSource), Encoding.UTF8));
        });
    }
    ...
    private static string GenerateTagHelper(IslandModel model)
    {
        ...
        sb.AppendLine("using SoftMax.LaughTale.Core.Enums;");
        sb.AppendLine("using SoftMax.LaughTale.Core.Serialization;");
        sb.AppendLine();
    ...
    private static string GenerateTypeScriptContracts(ImmutableArray<IslandModel> models)
    {
        var sb = new StringBuilder();
        sb.AppendLine("/**");
        sb.AppendLine(" * Auto-generated by SoftMax.LaughTale.Generators");
        sb.AppendLine(" */");
        sb.AppendLine();
...
namespace SoftMax.LaughTale.Generated
{{
