...
function MenuIsland(container, props) {
  ...
  function normalizeItems(rawList) {
    ...
    return rawList.map((it) => {
      ...
      return {
        ...
        toggleable: it.toggleable !== void 0 ? it.toggleable : it.Toggleable !== void 0 ? it.Toggleable : void 0,
        linkClass: it.linkClass || it.LinkClass,
        command: it.command || it.Command,
        checked: it.checked !== void 0 ? it.checked : it.Checked,
        radioGroup: it.radioGroup || it.RadioGroup,
        radioSelected: it.radioSelected !== void 0 ? it.radioSelected : it.RadioSelected
      };
    });
  }
  ...
  function setRadioSelection(list, group, selectedItem) {
    list.forEach((it) => {
      if (it.radioGroup === group && it.radioSelected !== void 0) {
...
//# sourceMappingURL=menu-ZFNGOGJ6.js.map
