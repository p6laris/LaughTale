...
// ../SoftMax.LaughTale.Client/src/components/panel.ts
var SVG_ICONS = {
...
`;
function PanelIsland(container, props) {
  ...
  const panelEl = container.querySelector(".p-panel") || container;
  const toggleBtn = container.querySelector(".p-panel-toggle-button");
  const iconSpan = container.querySelector(".p-panel-toggle-icon");
  function updateState(collapsed) {
    ...
    if (isControlled) {
      container.querySelectorAll(".p-panel-ctrl-btn").forEach((btn) => {
...
export {
  PanelIsland as default
};
//# sourceMappingURL=panel-6YY5LZTY.js.map
