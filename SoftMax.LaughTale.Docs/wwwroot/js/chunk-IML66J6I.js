  ...
  allElements.forEach((el) => {
    for (const attr of Array.from(el.attributes)) {
      if (attr.name === "l-bind" || attr.name.startsWith("l-bind:") || attr.name === "l-model" || attr.name === "l-class" || attr.name === "l-style") {
        import("./reactivity-52BZ4TXQ.js").then(({ getNearestScope: getNearestScope2 }) => {
...
defineIsland("tree-select", () => import("./tree-select-DGGTYVLW.js"));
defineIsland("datagrid", () => import("./datagrid-KKMGRJAS.js"));
defineIsland("modal", () => import("./modal-WTCABZ2L.js"));
defineIsland("toast", () => import("./toast-CK4RC3K7.js"));
defineIsland("input-number", () => import("./input-number-SG7NTD4P.js"));
defineIsland("input-otp", () => import("./input-otp-M3CC4OS5.js"));
defineIsland("input-password", () => import("./input-password-RX7NLN42.js"));
defineIsland("toggle-switch", () => import("./toggle-switch-6BKP457R.js"));
defineIsland("slider", () => import("./slider-G3B77MUG.js"));
defineIsland("rating", () => import("./rating-HJVNBIAL.js"));
defineIsland("select-button", () => import("./select-button-EQJW2VI3.js"));
defineIsland("chips", () => import("./chips-CRFDDDOM.js"));
defineIsland("datepicker", () => import("./datepicker-VMPSO2P2.js"));
...
defineIsland("drawer", () => import("./drawer-IAJEVWXV.js"));
defineIsland("speed-dial", () => import("./speed-dial-NCMSHUUZ.js"));
defineIsland("image-compare", () => import("./image-compare-ZFPGGMPJ.js"));
defineIsland("confirm-popup", () => import("./confirm-popup-PQNAEEBK.js"));
defineIsland("accordion", () => import("./accordion-ZNW47B2Q.js"));
defineIsland("tabs", () => import("./tabs-JDB5FBFK.js"));
defineIsland("autocomplete", () => import("./autocomplete-VWYMNWSN.js"));
defineIsland("color-picker", () => import("./color-picker-EI654GJB.js"));
defineIsland("knob", () => import("./knob-NZDMX3JY.js"));
defineIsland("tag", () => import("./tag-WY2H6M4R.js"));
defineIsland("breadcrumb", () => import("./breadcrumb-OZ7XCKCS.js"));
defineIsland("scroll-top", () => import("./scroll-top-NWXYY57H.js"));
defineIsland("inplace", () => import("./inplace-RXCJA6RE.js"));
defineIsland("command", () => import("./command-ZYSIAGSF.js"));
defineIsland("theme-studio", () => import("./theme-studio-AIXMSJD3.js"));
defineIsland("dynamic-form", () => import("./dynamic-form-6WWVJ4IQ.js"));
defineIsland("splitter", () => import("./splitter-NGISEAKF.js"));
defineIsland("multiselect", () => import("./multiselect-6ZY7BS4X.js"));
defineIsland("cascadeselect", () => import("./cascadeselect-XLDDMOXE.js"));
defineIsland("listbox", () => import("./listbox-O4JNRR3T.js"));
defineIsland("picklist", () => import("./picklist-4BY22F73.js"));
defineIsland("orderlist", () => import("./orderlist-E5Z6P75F.js"));
defineIsland("orgchart", () => import("./orgchart-NNJTN7SK.js"));
defineIsland("terminal", () => import("./terminal-7UHOCW7E.js"));
defineIsland("dock", () => import("./dock-EMZZIOE4.js"));
defineIsland("galleria", () => import("./galleria-BD7LFQYP.js"));
defineIsland("blockui", () => import("./blockui-EQX3MLEV.js"));
defineIsland("split-button", () => import("./split-button-OIBAAVY5.js"));
...
//# sourceMappingURL=chunk-IML66J6I.js.map
