...
description: "Master the 6 client hydration strategies in LaughTale"
order: 2
...
LaughTale gives you granular control over exactly **when and how** each component's JavaScript is loaded and executed in the browser.
