...
public class RoslynDiagnosticTests
{
    ...
    public void LTI001_Validates_KebabCase_Island_Names(string name, bool isValid)
    {
    ...
    public void LTI002_Identifies_NonSerializable_Banned_Types(string typeFullName, bool isBanned)
    {
    ...
    public void LTI004_Detects_Sensitive_Credential_Property_Names(string propertyName, bool isSensitive)
    {
