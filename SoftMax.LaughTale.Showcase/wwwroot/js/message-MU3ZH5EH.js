...
// ../SoftMax.LaughTale.Client/src/components/message.ts
var MESSAGE_CSS = `
/* ==========================================================================
...
function MessageIsland(container, props) {
  ...
  function getCustomIconSvg(iconName) {
    if (!iconName) return "";
  ...
  function renderSingleMessage(p, initialHtmlText) {
  ...
  if (isDynamic) {
    let renderDynamicContainer2 = function() {
    ...
    container.innerHTML = renderDynamicContainer2();
    wireDynamic2();
    return;
  }
...
export {
  MessageIsland as default
};
//# sourceMappingURL=message-MU3ZH5EH.js.map
