...
`;
var PLAY_ICON_SVG = `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" style="margin-left: 2px;"><polygon points="6 3 20 12 6 21 6 3"/></svg>`;
var PAUSE_ICON_SVG = `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"><rect x="6" y="4" width="4" height="16"/><rect x="14" y="4" width="4" height="16"/></svg>`;
function ToolbarIsland(container, props) {
  ...
  const formatButtons = rootEl.querySelectorAll('[aria-label="Bold"], [aria-label="Italic"], [aria-label="Underline"]');
  ...
  const alignButtons = rootEl.querySelectorAll('[aria-label="Align Left"], [aria-label="Align Center"], [aria-label="Align Right"]');
  ...
  const viewButtons = rootEl.querySelectorAll('[aria-label="Grid View"], [aria-label="List View"]');
  ...
  const playBtn = rootEl.querySelector('[aria-label="Play"], [aria-label="Pause"]');
  let isPlaying = false;
  if (playBtn) {
  ...
  const starBtn = rootEl.querySelector("button:has(svg polygon)");
...
//# sourceMappingURL=toolbar-VX2UT74A.js.map
