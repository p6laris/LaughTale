...
public class IslandNumberTagHelper : TagHelper
{
    ...
    public override void Process(TagHelperContext context, TagHelperOutput output)
    {
        ...
        if (ShowButtons && ButtonLayout == ButtonLayout.Horizontal)
        {
            ...
            sb.Append(LaughTale.Components.Icons.LucideIcons.Get("minus", 14));
            sb.Append("</button>");
        }
        else if (ShowButtons && ButtonLayout == ButtonLayout.Vertical)
        {
            ...
            sb.Append(LaughTale.Components.Icons.LucideIcons.Get("plus", 14));
            sb.Append("</button>");
        }
        ...
        if (ShowClear && Value.HasValue && !Disabled)
        {
            ...
            sb.Append(LaughTale.Components.Icons.LucideIcons.Get("x", 14));
            sb.Append("</button>");
        }
        ...
        if (ShowButtons)
        {
            if (ButtonLayout == ButtonLayout.Stacked)
            {
                ...
                sb.Append($"<button type=\"button\" class=\"p-inputnumber-button p-inputnumber-button-up\" tabindex=\"-1\" {disabledAttr} aria-label=\"Increment\">");
                sb.Append(LaughTale.Components.Icons.LucideIcons.Get("chevron-up", 14));
                sb.Append("</button>");
                sb.Append($"<button type=\"button\" class=\"p-inputnumber-button p-inputnumber-button-down\" tabindex=\"-1\" {disabledAttr} aria-label=\"Decrement\">");
                sb.Append(LaughTale.Components.Icons.LucideIcons.Get("chevron-down", 14));
                sb.Append("</button>");
                sb.Append("</div>");
            }
...
public class IslandPasswordTagHelper : TagHelper
{
    ...
    public override void Process(TagHelperContext context, TagHelperOutput output)
    {
        ...
        if (!string.IsNullOrEmpty(Icon))
        {
            ...
            sb.Append(LaughTale.Components.Icons.LucideIcons.Get(Icon, 16));
            sb.Append("</span>");
        }
        ...
        if (ToggleMask)
        {
            ...
            sb.Append(LaughTale.Components.Icons.LucideIcons.Get("eye", 16));
            sb.Append("</button>");
        }
...
public class IslandInputTagsTagHelper : TagHelper
{
    ...
    public override void Process(TagHelperContext context, TagHelperOutput output)
    {
        ...
        var sb = new System.Text.StringBuilder();
        var xCircleIcon = LaughTale.Components.Icons.LucideIcons.Get("x", 14);
...
public class IslandInputGroupAddonTagHelper : TagHelper
{
    ...
    public override void Process(TagHelperContext context, TagHelperOutput output)
    {
        ...
        if (!string.IsNullOrEmpty(Icon))
        {
            output.Content.AppendHtml(LaughTale.Components.Icons.LucideIcons.Get(Icon, 16));
        }
...
public class IslandEnhancedInputTextTagHelper : TagHelper
{
    ...
    public override void Process(TagHelperContext context, TagHelperOutput output)
    {
        ...
        if (!string.IsNullOrEmpty(effectiveLeftIcon))
        {
            ...
            sb.Append(LaughTale.Components.Icons.LucideIcons.Get(effectiveLeftIcon, 16));
            sb.Append("</span>");
        }
        ...
        if (!string.IsNullOrEmpty(IconRight))
        {
            ...
            sb.Append(LaughTale.Components.Icons.LucideIcons.Get(IconRight, 16));
            sb.Append("</span>");
        }
