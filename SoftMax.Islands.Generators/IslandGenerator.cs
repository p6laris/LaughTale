...
namespace SoftMax.Islands.Generators;

/// <summary>
/// Roslyn Incremental Source Generator &amp; Diagnostic Analyzer for SoftMax.Islands.
...
{
    private const string IslandAttributeName = "SoftMax.Islands.Core.Attributes.IslandAttribute";
    private const string GenerateTypeScriptAttributeName = "SoftMax.Islands.Core.Attributes.GenerateTypeScriptAttribute";
    ...
    private static readonly DiagnosticDescriptor InvalidIslandNameRule = new(
        ...
        category: "SoftMax.Islands.Naming",
    ...
    private static readonly DiagnosticDescriptor NonSerializableTypeRule = new(
        ...
        category: "SoftMax.Islands.Serialization",
    ...
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        ...
        context.RegisterSourceOutput(allIslands, static (spc, results) =>
        {
            ...
            spc.AddSource("SoftMax.Islands.TypeScriptManifest.g.cs", SourceText.From(GenerateManifestComment(tsSource), Encoding.UTF8));
        });
    }
    ...
    private static string GenerateTagHelper(IslandModel model)
    {
        ...
        sb.AppendLine("using SoftMax.Islands.Core.Enums;");
        sb.AppendLine("using SoftMax.Islands.Core.Serialization;");
        sb.AppendLine();
    ...
    private static string GenerateTypeScriptContracts(ImmutableArray<IslandModel> models)
    {
        var sb = new StringBuilder();
        sb.AppendLine("/**");
        sb.AppendLine(" * Auto-generated by SoftMax.Islands.Generators");
        sb.AppendLine(" */");
        sb.AppendLine();
...
namespace SoftMax.Islands.Generated
{{
