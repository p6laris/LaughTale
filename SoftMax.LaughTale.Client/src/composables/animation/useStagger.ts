/**
 * SoftMax.LaughTale: Composable useStagger Animation
 * Cascading staggered entrance animations for lists, tables, cards, and grids.
 */
...
export function useStagger(elements: HTMLElement[] | NodeListOf<HTMLElement>, options: StaggerOptions = {}) {
