 ...
 * High-performance file uploader supporting Basic & Advanced modes, drag-and-drop zones,
 * automatic uploads, custom progress tracking, image thumbnail previews, and file validations.
 */
...
export default function FileUploadIsland(container: HTMLElement, props: FileUploadProps) {
    ...
    const chooseLabel = props.chooseLabel || 'Choose';
                ...
                <div class="p-fileupload-content">
                    ${!hasFiles ? `
                        <div class="p-fileupload-empty" data-click-trigger>
                            ...
                            <div style="font-size: 0.75rem; color: var(--p-text-muted);">or click to browse from device</div>
                        </div>
                    ` : (previewImages ? `
