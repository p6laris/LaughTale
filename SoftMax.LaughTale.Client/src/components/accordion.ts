/**
 * SoftMax.LaughTale: Enterprise Accordion & Collapsible Panel (Aura Accordion inspired)
 */
...
export default function AccordionIsland(container: HTMLElement, props: AccordionProps) {
    ...
    if (Array.isArray(props.activeIndex)) {
        ...
        activeIndices.add(0); // default open first
    }
    ...
    function render() {
        ...
        // Slot projection support for Razor slots: <div data-slot="tab-0">...</div>
        tabs.forEach((_, idx) => {
