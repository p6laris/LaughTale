 ...
 * single unified rounded pill, border-collapse, unclipped focus rings,
 * native inputs, selects, buttons, checkboxes, and floating labels.
 */
...
export function InputGroupAddonIsland(container: HTMLElement, props: InputGroupAddonProps) {
    ...
    // Inject icon if missing from server render
