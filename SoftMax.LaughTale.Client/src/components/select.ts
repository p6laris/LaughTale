...
import { useDisclosure, useClickOutside, useFloatingPosition, useKeyboardNav } from '../composables';
...
export default function SelectIsland(container: HTMLElement, props: SelectProps) {
    ...
    function bindEvents() {
        ...
        const filterInput = container.querySelector('.laughtale-select-filter input') as HTMLInputElement;
        ...
        listItems.forEach(item => {
            item.addEventListener('click', () => {
                selectedValue = (item as HTMLElement).dataset.value!;
                isOpen = false;
                searchTerm = '';
                render();
            });
        ...
        if (filterInput) {
            filterInput.addEventListener('input', (e) => {
                ...
                render();
                const newInput = container.querySelector('.laughtale-select-filter input') as HTMLInputElement;
                if (newInput) {
                    newInput.focus();
