/**
 * SoftMax.LaughTale: Official Solar Icons Vector Dictionary (Zero external fonts)
 */

export const SolarIcons: Record<string, string> = {
...
export function getSolarIcon(name: keyof typeof SolarIcons): string {
