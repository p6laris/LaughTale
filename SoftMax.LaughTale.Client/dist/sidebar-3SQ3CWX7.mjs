import{b as v}from"./chunk-P6B5FGGY.mjs";import{e as q}from"./chunk-3YU53HBK.mjs";var Q=`
/* ==========================================================================
...
`;function K(i,r){if(q("sidebar",Q),Array.isArray(r.items)&&r.items.length>0&&!r.groups){let m=[];r.items.forEach(c=>{let y=c.label||c.Label||"",x=c.items||c.Items;if(Array.isArray(x)&&x.length>0){let w=x.map(n=>({label:n.label||n.Label||"",icon:n.icon||n.Icon||c.icon||c.Icon||"folder",url:n.url||n.Url,isActive:n.active||n.Active||!1,badge:n.badge||n.Badge,defaultOpen:n.expanded||n.Expanded||!1}));m.push({label:y,items:w})}else m.push({label:"",items:[{label:y,icon:c.icon||c.Icon||"folder",url:c.url||c.Url,isActive:c.active||c.Active||!1,badge:c.badge||c.Badge}]})}),D(i,{...r,groups:m,demoType:"app",headerTitle:r.title||"SoftMax Aura",collapsible:"icon",variant:"sidebar",width:"16.5rem",open:!r.collapsed})}else D(i,r)}function D(i,r){let b=r.demoType||r.DemoType||"variants",m=b==="app",c=r.showControls!==!1&&b==="variants",y=r.variant||r.Variant||"sidebar",x=r.collapsible||r.Collapsible||"icon",w=r.side||r.Side||"left",n=r.overlay||r.Overlay||!1,I=r.openOnHover||r.OpenOnHover||!1,E=r.backdrop||r.Backdrop||!1,p=r.open!==void 0?r.open:r.Open!==void 0?r.Open:!0,M=r.width||r.Width||(b==="chat"?"18rem":"16.5rem"),L="",j=null,k={name:"Acme Inc",logo:"A",color:"linear-gradient(135deg, #8b5cf6, #4f46e5)"},S=!1,C=!1,z={};function O(t){return t?t.startsWith("<svg")?t:v[t]?v[t]:"":""}let V=[{label:"Navigation",items:[{icon:"home",label:"Home",isActive:!0},{icon:"mail",label:"Inbox",badge:"12"},{icon:"search",label:"Search"},{icon:"bell",label:"Notifications",badge:"3"}]},{label:"Projects",items:[{icon:"barChart3",label:"Analytics",defaultOpen:!0,subItems:[{label:"Overview",isActive:!0},{label:"Reports"},{label:"Real-time"}]},{icon:"users",label:"Team"},{icon:"calendar",label:"Calendar"},{icon:"folder",label:"Documents",subItems:[{label:"Shared"},{label:"Private"},{label:"Archived"}]}]},{label:"Billing",items:[{icon:"creditCard",label:"Payments"},{icon:"shoppingCart",label:"Orders"},{icon:"star",label:"Subscriptions"}]}],T=r.groups||V;function H(t){return t.map((d,o)=>{let s=L?d.items.filter(a=>a.label.toLowerCase().includes(L.toLowerCase())):d.items;if(s.length===0&&L)return"";let f=s.map((a,$)=>{let e=`${o}_${$}`;a.defaultOpen&&z[e]===void 0&&(z[e]=!0);let l=!!z[e],g=Array.isArray(a.subItems)&&a.subItems.length>0,u=b==="chat"?"":O(a.icon),P="";if(g){let N=a.subItems.map(G=>`
                        <li class="p-sidebar-menu-sub-item">
                            <button type="button" class="p-sidebar-menu-sub-button ${G.isActive?"p-active":""}">
                                <span>${G.label}</span>
                            </button>
                        </li>
                    `).join("");P=`
                        <div class="p-sidebar-menu-sub-wrapper ${l?"p-expanded":""}">
                            <ul class="p-sidebar-menu-sub">${N}</ul>
                        </div>
                    `}let Z=`<svg class="p-sidebar-submenu-chevron ${l?"p-expanded":""}" xmlns="http://www.w3.org/2000/svg" width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg>`,_=b==="chat"?'<button type="button" class="p-sidebar-menu-action" title="Delete conversation" style="border:none;"><svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 6h18"/><path d="M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6"/><path d="M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2"/></svg></button>':a.badge===void 0?'<svg class="p-sidebar-menu-action" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="1"/><circle cx="12" cy="5" r="1"/><circle cx="12" cy="19" r="1"/></svg>':"",Y=a.url?`<a href="${a.url}" class="p-sidebar-menu-button ${a.isActive?"p-active":""}" data-sidebar-link="${a.url}" title="${a.label}">`:`<button type="button" class="p-sidebar-menu-button ${a.isActive?"p-active":""}" data-has-subs="${g}" title="${a.label}">`,J=a.url?"</a>":"</button>";return`
                    <li class="p-sidebar-menu-item" data-subkey="${e}">
                        ${Y}
                            ${u?`<span class="p-sidebar-menu-button-icon">${u}</span>`:""}
                            <span class="p-sidebar-item-label">${a.label}</span>
                            ${a.badge!==void 0?`<span class="p-sidebar-menu-badge">${a.badge}</span>`:""}
                            ${g?Z:m?"":_}
                        ${J}
                        ${P}
                    </li>
                ...
                <div class="p-sidebar-group">
                    ${d.label?`<div class="p-sidebar-group-label">${d.label}</div>`:""}
                    <ul class="p-sidebar-menu">${f}</ul>
                </div>
            `}).join("")}function W(){let t=r.headerTitle||"SoftMax Aura";return m?`
                <div style="display: flex; align-items: center; gap: 0.65rem; width: 100%; overflow: hidden;">
                    <a href="/" style="display: flex; width: 2.1rem; height: 2.1rem; border-radius: 8px; background: linear-gradient(135deg, #10b981, #047857); color: #ffffff; align-items: center; justify-content: center; flex-shrink: 0; text-decoration: none;" title="${t}">
                        ${v.layers||'<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="m12.83 2.18a2 2 0 0 0-1.66 0L2.6 6.08a1 1 0 0 0 0 1.83l8.58 3.9a2 2 0 0 0 1.66 0l8.58-3.9a1 1 0 0 0 0-1.83Z"/><path d="m22 17.65-9.17 4.16a2 2 0 0 1-1.66 0L2 17.65"/><path d="m22 12.65-9.17 4.16a2 2 0 0 1-1.66 0L2 12.65"/></svg>'}
                    </a>
                    <span class="p-sidebar-item-label p-sidebar-header-label" style="font-weight: 800; font-size: 0.9375rem; color: var(--p-text-color);">${t}</span>
                </div>
            `:b==="chat"?`
                ...
                <ul class="p-sidebar-menu" style="margin-top: 0.45rem; border-bottom: 1px solid var(--p-border-color); padding-bottom: 0.45rem;">
                    <li class="p-sidebar-menu-item">
                        <button type="button" class="p-sidebar-menu-button">
                            <span class="p-sidebar-menu-button-icon">${v.search}</span>
                            <span class="p-sidebar-item-label">Search</span>
                        </button>
                    </li>
                    <li class="p-sidebar-menu-item">
                        <button type="button" class="p-sidebar-menu-button">
                            <span class="p-sidebar-menu-button-icon"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.375 2.625a2.121 2.121 0 1 1 3 3L12 15l-4 1 1-4Z"/></svg></span>
                            <span class="p-sidebar-item-label">New chat</span>
                        </button>
                    </li>
                    <li class="p-sidebar-menu-item">
                        <button type="button" class="p-sidebar-menu-button">
                            <span class="p-sidebar-menu-button-icon">${v.globe}</span>
                    ...
                    <ul class="p-sidebar-menu">
                        <li class="p-sidebar-menu-item">
                            <button type="button" class="p-sidebar-menu-button" data-company-trigger style="padding: 0.35rem 0.5rem;">
                                <div style="display:flex; width:1.5rem; height:1.5rem; border-radius:6px; background: ${k.color}; color:#fff; align-items:center; justify-content:center; font-weight:700; font-size:0.75rem; flex-shrink:0;">${k.logo}</div>
                                <span class="p-sidebar-item-label p-sidebar-header-label" style="font-weight: 700; font-size: 0.875rem;">${k.name}</span>
                                <svg class="p-sidebar-submenu-chevron" style="margin-left: auto;" xmlns="http://www.w3.org/2000/svg" width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg>
                            </button>
                        </li>
                    </ul>
                    ${S?`
                        <div class="p-sb-popup-menu" style="top: 100%; left: 0; margin-top: 0.25rem;">
                            ...
                            <div class="p-sb-popup-item" data-select-company="Acme Inc|A|linear-gradient(135deg, #8b5cf6, #4f46e5)">
                                ...
                                <span>Acme Inc</span>
                                ${k.name==="Acme Inc"?'<span style="margin-left:auto; color:var(--p-primary-600); font-weight:700;">&#10003;</span>':""}
                            </div>
                            <div class="p-sb-popup-item" data-select-company="Globex Corp|G|linear-gradient(135deg, #10b981, #0d9488)">
                                ...
                                ${k.name==="Globex Corp"?'<span style="margin-left:auto; color:var(--p-primary-600); font-weight:700;">&#10003;</span>':""}
                            </div>
                            <div class="p-sb-popup-item" data-select-company="Initech|I|linear-gradient(135deg, #f97316, #dc2626)">
                                ...
                                <span>Initech</span>
                                ${k.name==="Initech"?'<span style="margin-left:auto; color:var(--p-primary-600); font-weight:700;">&#10003;</span>':""}
                            </div>
                            ...
                            <div class="p-sb-popup-item" style="color: var(--p-text-muted);">
                                <span class="p-sidebar-menu-button-icon">${v.plus}</span>
                    ...
                    ${C?`
                        <div class="p-sb-popup-menu" style="bottom: 100%; left: 0; margin-bottom: 0.25rem;">
                            ...
                            <div class="p-sb-popup-item">
                                <span class="p-sidebar-menu-button-icon">${v.settings}</span>
                                <span>Settings</span>
                            </div>
                            <div class="p-sb-popup-item">
                                <span class="p-sidebar-menu-button-icon">${v.bell}</span>
                                <span>Notifications</span>
                            </div>
                            <div style="border-top: 1px solid var(--p-border-color); margin: 0.25rem 0;"></div>
                            <div class="p-sb-popup-item" style="color: #ef4444;">
                                <span class="p-sidebar-menu-button-icon">${v.logOut}</span>
                                <span>Sign out</span>
                            </div>
                        </div>
                    `:""}
        ...
        `}function U(){let t='<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="18" x="3" y="3" rx="2"/><path d="M9 3v18"/></svg>',d='<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M7.9 20A9 9 0 1 0 4 16.1L2 22Z"/></svg>';return b==="chat"?`
                <div class="p-sidebar-main">
                    <header class="p-sidebar-main-header" style="justify-content: space-between;">
                        ...
                        <button type="button" class="p-sidebar-trigger" title="New chat">
                            <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.375 2.625a2.121 2.121 0 1 1 3 3L12 15l-4 1 1-4Z"/></svg>
                        </button>
                    </header>
...
&lt;/Sidebar&gt;</div>
            ...
            <div class="p-sidebar-main">
                <header class="p-sidebar-main-header">
                    ...
                    <span style="font-size: 0.875rem; font-weight: 600; color: var(--p-text-color);">Dashboard</span>
                    ${b==="responsive"?'<span style="margin-left: auto; font-size: 0.75rem; font-weight: 600; padding: 0.2rem 0.5rem; border-radius: 6px; background: var(--p-surface-100); color: var(--p-text-muted);">Desktop</span>':""}
                </header>
                <div style="flex: 1; padding: 1rem; display: flex; flex-direction: column; gap: 1rem; overflow-y: auto;">
                    <div style="height: 6rem; border-radius: 8px; background: var(--p-surface-100); border: 1px solid var(--p-border-color); display: flex; align-items: center; justify-content: center; color: var(--p-text-muted); font-size: 0.875rem;">Main Content View</div>
                    <div style="flex: 1; min-height: 8rem; border-radius: 8px; background: var(--p-surface-100); border: 1px solid var(--p-border-color); display: flex; align-items: center; justify-content: center; color: var(--p-text-muted); font-size: 0.875rem;">Analytics &amp; Data Area</div>
        ...
        `}function A(){let t=i.querySelector("[data-sidebar-root]");if(!t)return;t.className=["p-sidebar",m?"p-sidebar-app-dock":"",`p-sidebar-variant-${y}`,`p-sidebar-collapsible-${x}`,`p-sidebar-side-${w}`,n?"p-sidebar-overlay":"",p?"":"p-sidebar-collapsed"].filter(Boolean).join(" ");let d=p?M:x==="icon"?"3.5rem":"0rem";t.style.width=d;let o=i.querySelector("[data-sidebar-backdrop]");o&&(o.style.display=E&&p?"block":"none")}function X(){let s=`
            <aside class="${["p-sidebar",m?"p-sidebar-app-dock":"",`p-sidebar-variant-${y}`,`p-sidebar-collapsible-${x}`,`p-sidebar-side-${w}`,n?"p-sidebar-overlay":"",p?"":"p-sidebar-collapsed"].filter(Boolean).join(" ")}" style="width: ${p?M:x==="icon"?"3.5rem":"0rem"};" data-sidebar-root>
                        ...
                        ${m?`
                            <div class="p-sidebar-search-container">
                                <div class="p-sidebar-search-box">
                                    <span style="color: var(--p-surface-400); display: flex; align-items: center;"><svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/></svg></span>
                                    <input type="text" class="p-sidebar-search-input" placeholder="Filter navigation..." value="${L}" />
                                </div>
                            </div>
                        `:""}
        ...
        `;if(m)return s;function f(){return`
                <div class="p-sidebar-toolbar">
                    <div class="p-sidebar-toolbar-field">
                        <span class="p-sidebar-toolbar-label">Side</span>
                        <button type="button" class="p-sb-select-trigger" data-sb-control="side">${w}</button>
                    </div>
                    <div class="p-sidebar-toolbar-field">
                        <span class="p-sidebar-toolbar-label">Variant</span>
                        <button type="button" class="p-sb-select-trigger" data-sb-control="variant">${y}</button>
                    </div>
                </div>
            `}let a=U(),$=`<div class="p-sidebar-backdrop" data-sidebar-backdrop style="display: ${E&&p?"block":"none"};"></div>`,e=w==="right"?a+s:s+a,l=`
        ...
        `;return c?`
            ...
            `:l}function F(){if(i.querySelectorAll("[data-sidebar-toggle]").forEach(e=>{e.addEventListener("click",l=>{l.stopPropagation(),p=!p,A()})}),m){let e=()=>{p=!p,A()};document.removeEventListener("app-sidebar:toggle",window.__appSidebarUnifiedHandler),window.__appSidebarUnifiedHandler=e,document.addEventListener("app-sidebar:toggle",e);let l=i.querySelector(".p-sidebar-search-input");l&&l.addEventListener("input",g=>{L=g.target.value;let u=i.querySelector(".p-sidebar-content");u&&(u.innerHTML=H(T),B())})}i.querySelectorAll("[data-sidebar-backdrop]").forEach(e=>{e.addEventListener("click",()=>{p=!1,A()})});let t=i.querySelector(".p-sidebar-main");t&&t.addEventListener("click",e=>{n&&p&&!e.target.closest("[data-sidebar-toggle]")&&(p=!1,A())}),B();let d=i.querySelector("[data-company-trigger]");d&&d.addEventListener("click",e=>{e.stopPropagation(),S=!S,C=!1,h()}),i.querySelectorAll("[data-select-company]").forEach(e=>{e.addEventListener("click",l=>{l.stopPropagation();let u=(e.getAttribute("data-select-company")||"").split("|");u.length>=3&&(k={name:u[0],logo:u[1],color:u[2]}),S=!1,h()})});let o=i.querySelector("[data-user-trigger]");o&&o.addEventListener("click",e=>{e.stopPropagation(),C=!C,S=!1,h()}),i.querySelectorAll("[data-select-trigger]").forEach(e=>{e.addEventListener("click",l=>{l.stopPropagation();let g=e.getAttribute("data-select-trigger");j=j===g?null:g,h()})}),i.querySelectorAll("[data-select-option]").forEach(e=>{e.addEventListener("click",l=>{l.stopPropagation();let[g,u]=(e.getAttribute("data-select-option")||"").split(":");g==="variant"?y=u:g==="collapsible"&&(x=u),j=null,h()})}),i.querySelectorAll("[data-sb-side]").forEach(e=>{e.addEventListener("click",l=>{l.stopPropagation(),w=e.getAttribute("data-sb-side"),h()})});let s=i.querySelector('[data-sb-toggle="overlay"]');s&&s.addEventListener("click",e=>{e.stopPropagation(),n=!n,h()});let f=i.querySelector('[data-sb-toggle="hover"]');f&&f.addEventListener("click",e=>{e.stopPropagation(),I=!I,h()});let a=i.querySelector('[data-sb-toggle="backdrop"]');if(a&&a.addEventListener("click",e=>{e.stopPropagation(),E=!E,h()}),I){let e=i.querySelector("[data-sidebar-root]");e&&(e.addEventListener("mouseenter",()=>{p||(p=!0,A())}),e.addEventListener("mouseleave",()=>{p&&(p=!1,A())}))}let $=()=>{(j||S||C)&&(j=null,S=!1,C=!1,h())};document.addEventListener("click",$,{once:!0})}function B(){i.querySelectorAll('.p-sidebar-menu-button[data-has-subs="true"]').forEach(t=>{t.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation();let o=t.closest(".p-sidebar-menu-item"),s=o?.getAttribute("data-subkey");if(s){z[s]=!z[s];let f=o?.querySelector(".p-sidebar-menu-sub-wrapper"),a=o?.querySelector(".p-sidebar-submenu-chevron");f&&f.classList.toggle("p-expanded",z[s]),a&&a.classList.toggle("p-expanded",z[s])}})}),i.querySelectorAll("a[data-sidebar-link]").forEach(t=>{t.addEventListener("click",d=>{let o=t.getAttribute("href")||"",s=o.indexOf("#");if(s>=0&&(o.startsWith("#")||o.startsWith(window.location.pathname))){let f=o.substring(s+1),a=document.getElementById(f);a&&(d.preventDefault(),a.scrollIntoView({behavior:"smooth",block:"start"}),i.querySelectorAll(".p-sidebar-menu-button").forEach($=>$.classList.remove("p-active")),t.classList.add("p-active"),window.history.pushState(null,"",o))}})})}function h(){i.innerHTML=X(),F()}h()}export{K as default};
