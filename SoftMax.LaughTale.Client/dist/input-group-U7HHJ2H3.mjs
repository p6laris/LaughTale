import{a as u}from"./chunk-P6B5FGGY.mjs";import{e as p}from"./chunk-3YU53HBK.mjs";var i=`
...
`;function o(t,r){p("laughtale-inputgroup",i),t.classList.add("laughtale-inputgroup","p-inputgroup"),r.size&&t.classList.add(`size-${r.size}`)}function n(t,r){if(p("laughtale-inputgroup",i),t.classList.add("laughtale-inputgroup-addon","p-inputgroup-addon"),r.icon&&!t.querySelector("svg")){let a=u(r.icon);a&&t.insertAdjacentHTML("afterbegin",a)}r.text&&!t.querySelector("span")&&!t.textContent?.trim()&&t.insertAdjacentHTML("beforeend",`<span>${r.text}</span>`)}export{n as InputGroupAddonIsland,o as default};
