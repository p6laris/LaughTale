import{e as r}from"./chunk-3YU53HBK.mjs";var t=`
.p-divider {
...
`;function o(e,i){r("divider",t);let d=i.layout==="vertical";e.classList.add("p-divider","p-component"),e.classList.add(d?"p-divider-vertical":"p-divider-horizontal"),e.classList.add(`p-divider-${i.type||"solid"}`),e.classList.add(`p-divider-${i.align||(d?"center":"left")}`),e.setAttribute("role","separator"),e.setAttribute("aria-orientation",d?"vertical":"horizontal")}export{o as default};
